...
const char* ei_classifier_inferencing_categories[] = { "pitch negative", "pitch positive", "roll negative", "roll positive", "yaw negative", "yaw positive" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_10_axes[] = { 0, 1, 2, 3, 4, 5 };
const uint32_t ei_dsp_config_10_axes_size = 6;
ei_dsp_config_spectral_analysis_t ei_dsp_config_10 = {
    10, // uint32_t blockId
...
const uint32_t ei_learning_block_9_inputs[1] = { 10 };
...
const ei_impulse_t impulse_610825_0 = {
    .project_id = 610825,
    .project_owner = "Instituto de Investigación en Ingeniería de Aragón (I3A)",
    .project_name = "Inclinacion_Buena",
    .impulse_id = 2,
...
ei_impulse_handle_t impulse_handle_610825_0 = ei_impulse_handle_t( &impulse_610825_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_610825_0;
