...
#define EI_CLASSIFIER_PROJECT_ID                 610825
#define EI_CLASSIFIER_PROJECT_OWNER              "Instituto de Investigación en Ingeniería de Aragón (I3A)"
#define EI_CLASSIFIER_PROJECT_NAME               "Inclinacion_Buena"
